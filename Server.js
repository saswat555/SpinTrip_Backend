...
const io = new Server(server, {
    cors: {
        origin: ['https://spintrip.in', 'http://localhost', 'http://localhost:3000','http://13.232.236.183:3000', 'http://3.109.122.29:3000']
    }
});
...
// Middleware
app.use(helmet());
app.use(cors({ origin: ['https://spintrip.in', 'http://localhost', 'http://localhost:3000','http://13.232.236.183:3000', 'http://3.109.122.29:3000'] }));
